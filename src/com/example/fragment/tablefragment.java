...
public class tablefragment  extends Fragment {
	...
	private List<coursetableday>  as=new ArrayList<coursetableday>();
	private Handler handler=new Handler(){
		...
		public void handleMessage(android.os.Message msg) {
			if (msg.what==2) {
				...
				Log.i("-----table---count2", cursor.getCount()+"");	
				if(cursor.getCount()==0){
					Toast.makeText(context, "加载失败，下拉刷新试试！", 0).show();
				}else {
					...
					t1_1.setText(as.get(0).getOne());
					t2_1.setText(as.get(0).getTwo());
					t3_1.setText(as.get(0).getThree());
					t4_1.setText(as.get(0).getFour());
					t5_1.setText(as.get(0).getFive());

					t1_3.setText(as.get(1).getOne());
					t2_3.setText(as.get(1).getTwo());
					t3_3.setText(as.get(1).getThree());
					t4_3.setText(as.get(1).getFour());
					t5_3.setText(as.get(1).getFive());

					t1_5.setText(as.get(2).getOne());
					t2_5.setText(as.get(2).getTwo());
					t3_5.setText(as.get(2).getThree());
					t4_5.setText(as.get(2).getFour());
					t5_5.setText(as.get(2).getFive());

					t1_7.setText(as.get(3).getOne());
					t2_7.setText(as.get(3).getTwo());
					t3_7.setText(as.get(3).getThree());
					t4_7.setText(as.get(3).getFour());
					t5_7.setText(as.get(3).getFive());

					t1_9.setText(as.get(4).getOne());
					t2_9.setText(as.get(4).getTwo());
					t3_9.setText(as.get(4).getThree());
					t4_9.setText(as.get(4).getFour());
					t5_9.setText(as.get(4).getFive());
	...
	public void onResume() {
		...
		if(info!=null&& info.isAvailable()){
			if (as.isEmpty()) {
				//	dialog=ProgressDialog.show(context, "提示", "加载课程......");
				Log.e("course", "zhixing");
				getdate();
		...
		new Thread(new Runnable() {
			...
			public void run() {
				if(number!=null){
					...
					Cursor cursor= db.query("coursetable",new String[]{"_id","one","two","three","four","five"},
							null,null,null,null,null);
					Log.i("----table-----count1", ""+cursor.getCount());
